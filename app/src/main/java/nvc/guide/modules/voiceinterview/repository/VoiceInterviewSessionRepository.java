package nvc.guide.modules.voiceinterview.repository;

import nvc.guide.modules.voiceinterview.model.VoiceInterviewSessionEntity;
import nvc.guide.modules.voiceinterview.model.VoiceInterviewSessionEntity.InterviewPhase;
...
public interface VoiceInterviewSessionRepository extends JpaRepository<VoiceInterviewSessionEntity, Long> {
    ...
    Optional<VoiceInterviewSessionEntity> findByStatusAndEndTimeBefore(
        nvc.guide.common.model.AsyncTaskStatus status,
        LocalDateTime time
    );
    ...
    List<VoiceInterviewSessionEntity> findByEvaluateStatusAndUpdatedAtBefore(
        nvc.guide.common.model.AsyncTaskStatus evaluateStatus,
        LocalDateTime time
    );
}
