...
import nvc.guide.common.exception.RateLimitExceededException;
...
public class RateLimitAspect {
     ...
     */
    @Around("@annotation(nvc.guide.common.annotation.RateLimit) || " +
            "@annotation(nvc.guide.common.annotation.RateLimit.Container)")
